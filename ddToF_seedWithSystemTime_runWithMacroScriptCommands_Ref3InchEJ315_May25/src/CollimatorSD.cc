...
// Modified to CollimatorSD.cc at 2014-08-14 17:15 by Junhui Liao $
//
/// \file CollimatorSD.cc
/// \brief Implementation of the CollimatorSD class
...
CollimatorSD::CollimatorSD(G4String name)
: G4VSensitiveDetector(name), fHitsCollection(0), fHCID(-1)
{
     
    G4String HCname = "collimatorColl";
...
{
    fHitsCollection = new CollimatorHitsCollection
...
G4bool CollimatorSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
    ...
    {
        CollimatorHit* hit = new CollimatorHit(copyNo,hitTime);
        ///CollimatorHit* hit = new CollimatorHit(copyNo,hitTime,depositeE);///this method shows the E 
