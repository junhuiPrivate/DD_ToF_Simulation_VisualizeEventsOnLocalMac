...
DMXPhysicsList::DMXPhysicsList() : G4VUserPhysicsList() 
{
  ...
  defaultCutValue     = 1.0*centimeter; //
...
void DMXPhysicsList::ConstructParticle() 
{
  ...
  ConstructMyLeptons();
  ConstructMyHadrons();
  ///ConstructMyShortLiveds();/// closed by Jun, Mar 10, 2018
...
void DMXPhysicsList::ConstructMyBosons()
{
  ...
  //OpticalPhotons
  ///G4OpticalPhoton::OpticalPhotonDefinition();/// closed by Jun, Mar 10, 2018
...
void DMXPhysicsList::ConstructProcess() 
{
  ...
  ///ConstructOp();/// closed by Jun, Mar 10, 2018

  ConstructHad();

  ///ConstructGeneral();/// closed by Jun, Mar 10, 2018
...
/*
void DMXPhysicsList::ConstructOp() /// closed by Jun, Mar 10, 2018
{
